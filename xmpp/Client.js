...
module.exports = class Client extends EventEmitter {
    ...
    handleauth(message) {
        ...
        this.botJid = `NeoRiftBot@prod.ol.epicgames.com/V2:Fortnite:WIN::${parsed[0]}`
        ...
        if (message.root.attributes.type == "chat") {
            ...
            if (msg.startsWith("!skin ")) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=outfit`).then(response => {
                    ...
                    fs.writeFile('./config/NeoRiftBot/config.json', JSON.stringify({
            ...
            'message': {
                ...
                'body': {
                    "#text": JSON.stringify({
                        ...
                        "ns": "Fortnite",
                        "party_id": partyID,
                        "account_id": "NeoRiftBot",
                        "account_dn": "NeoRiftBot",
                        "member_state_updated": {
                            "urn:epic:member:dn_s": "NeoRiftBot",
                            "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"NeoRiftBot\",\"dn\":\"NeoRiftBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}"
                        },
                        "joined_at": new Date(),
                        "updated_at": new Date()
                    })
    ...
    JoinBot(PartyId) {
        ...
        setTimeout(() => {
            ...
            try {
                global.BotConfig = JSON.parse(fs.readFileSync('./config/NeoRiftBot/config.json', 'utf8', function (err, data) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "type": "com.epicgames.social.party.notification.v0.MEMBER_JOINED",
                            "connection": {
                                "id": `NeoRiftBot${this.NumberOfBot}@prod.ol.epicgames.com/V2:Fortnite:WIN::BOT${this.NumberOfBot}`,
                                "meta": {
                                    "urn:epic:conn:platform_s": "WIN",
                                    "urn:epic:conn:type_s": "game"
                                },
                            ...
                            "ns": "Fortnite",
                            "party_id": PartyId,
                            "account_id": `NeoRiftBot${this.NumberOfBot}`,
                            "account_dn": `NeoRiftBot`,
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": `{\"users\":[{\"id\":\"NeoRiftBot${this.NumberOfBot}\",\"dn\":\"NeoRiftBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}`,
                                "urn:epic:member:dn_s": `NeoRiftBot`
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "ns": "Fortnite",
                                "party_id": PartyId || "LobbyBotPartyLMFAO",
                                "account_id": `NeoRiftBot${counterLol}`,
                                "account_dn": `NeoRiftBot`,
                                "member_state_removed": [],
                                "member_state_updated": member_state_updated,
                                "joined_at": new Date(),
